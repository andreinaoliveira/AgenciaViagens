...
INSERT INTO `aeroporto` (`id`,`rua`,`bairro`,`estado`,`cidade`,`pais`,`cep`) VALUES 
 (1,'Av. Santos Dumont','Tarumã','AM','Manaus','Brasil','69041-000'),
 (2,'Rod. Hélio Smidt','s/nº','SP','Guarulhos','Brasil','07190-100'),
 (3,'Estr. São João','Do Eden','AM','Parintins','Brasil','69190-000'),
 (4,'-','Lago Sul','DF','Brasilia','Brasil','71608-900'),
 (5,'Arligton','VA 22202','WA','Virginia','Estados Unidos','-');
